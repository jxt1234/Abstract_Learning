...
#include "learn/ALRandomForestMatrix.h"
...
int test_main(int argc, char* argv[])
{
    ...
    ALSp<ALISuperviseLearner> learner = new ALRandomForestMatrix(500);
...
{
    // char* _argv[] = {"", "/Users/jiangxiaotang/machine_exam/handset/small.txt"};
    // test_main(2, _argv);
    test_main(argc, argv);
    return 1;
}
